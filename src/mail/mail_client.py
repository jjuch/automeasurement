...
class MailClient():
    ...
    def send_test_email(self, from_email: str, to_email: list, cc_email: list=None):
        ...
        return self.send_email(from_email, to_email, subject, body, cc_email=cc_email)
...
This message is automatically generated by the Automeasurement protocol. If it is not clear why you have received this message, please contact 'measurement.dysc@UGent.be'.
        ...
        return self.send_email(from_email, to_email, subject, body, cc_email=cc_email, high_priority=True)

    
    def send_warning_email(self, warning_text: str, warning_subject: str, from_email: str, to_email: list, cc_email: list=None):
        """
        Send an warning mail.
        """
        subject = '[Measurements.dysc] WARNING: {}'.format(warning_subject)
        body = """
============================================================     
The following warning occurred during the measurement protocol   
============================================================\n
{}\n\n
__________________________________________________________________
This message is automatically generated by the Automeasurement protocol. If it is not clear why you have received this message, please contact 'measurement.dysc@UGent.be'.
        ...
        return self.send_email(from_email, to_email, subject, body, cc_email=cc_email, high_priority=False)


    def send_info_email(self, info_text: str, info_subject: str, from_email: str, to_email: list, cc_email: list=None):
        """
        Send an info mail.
        """
        subject = '[Measurements.dysc] INFO: {}'.format(info_subject)
        body = """
===================================================================     
The measurement protocol wants to share the following info with you   
===================================================================\n
{}\n\n
__________________________________________________________________
This message is automatically generated by the Automeasurement protocol. If it is not clear why you have received this message, please contact 'measurement.dysc@UGent.be'.
...
if __name__ == "__main__":
    ...
    mc.send_test_email(cfg.email_from, cfg.email_to, cc_email=cfg.email_cc)
    mc.quit_client()