...
class MailClient():
    ...
    def send_email(self, from_email, to_email, subject, body, cc_email=None, high_priority=False):
        """
    ...
    def send_test_email(self, from_email, to_email, cc_email=None):
        """
    ...
    def send_error_email(self, error_text: str, error_subject: str, from_email, to_email, cc_email=None):
        """
        Send an error mail.
        """
